...
func TestOpenPort(t *testing.T) {
	...
	got, _ := PortScanner([2]int{1, 1024}, 100) // Currently function returns only number of open ports
...
func TestTotalPortsScanned(t *testing.T) {
	...
	_, got := PortScanner([2]int{1, 1024}, 100) // Currently function returns only number of open ports
